function getFormInput(){
    ...
    var dayIndex = new Date(date).getDay();
        ...
        document.getElementById('displayName').innerHTML ='<div class="alert alert-success" role="alert"> Congratulations!!! <br> Your Akan Name is: <span class="text-warning">'+akanName+'</span> you are a <span class="text-warning">'+gender+'</span> born on a <span class="text-warning">'+dayName+'</span> </div>'
